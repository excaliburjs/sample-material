import{_ as c,a as i,b as o,c as t,f as n,g as l}from"./excalibur-C1y0mcCw.js";import{g as v}from"./glsl-B_VQ82k_.js";const m="/sample-material/assets/perlin-CfX21HTc.png",x="/sample-material/assets/fractal-BrIN_dv3.png",p=v`#version 300 es
...
`,e=new c({width:800,height:800,displayMode:i.FitScreen,suppressPlayButton:!0,backgroundColor:o.fromRGB(100,60,120)}),a=new t(m),r=new t(x),f=new n([a,r]),s=new l({pos:e.screen.center,width:800,height:800,color:o.Transparent,z:1});s.graphics.material=e.graphicsContext.createMaterial({fragmentSource:p,images:{U_noise1:a,U_noise2:r}});e.add(s);e.start(f);
//# sourceMappingURL=index-CNNhHgKf.js.map
